<x-app-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('customers.store') }}" method="POST" class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                          class="w-full border-gray-300 rounded-lg shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
