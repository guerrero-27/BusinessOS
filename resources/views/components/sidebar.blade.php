    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5">
        @php
            $navItems = [
                ...
                ['route' => 'suppliers.index',  'label' => 'Suppliers',   'match' => 'suppliers*',   'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
            ];
        @endphp
        ...
        <div class="pt-3 pb-1">
            <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-widest">Insights</p>
        </div>
        ...
        <a href="{{ route('profile.edit') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition {{ request()->routeIs('profile.*') ? 'bg-[#111111] text-white' : 'text-gray-600 hover:bg-[#F4F5F7] hover:text-[#111111]' }}">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
