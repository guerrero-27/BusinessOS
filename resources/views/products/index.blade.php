<x-app-layout>
    ...
    @php
        $statusColors = [
            ...
            'draft'    => 'bg-[#F4F5F7] text-gray-600 border-black/10',
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 class="text-xl font-semibold text-[#111111]">Products</h1>
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center flex-wrap">
            <form action="{{ route('products.index') }}" method="GET" class="flex flex-wrap gap-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Name, SKU, barcode..."
                    class="w-full sm:w-48 rounded-lg border border-black/10 shadow-sm text-sm focus:border-[#4CAF50] focus:ring-[#4CAF50]">
                ...
                <select name="status" class="w-full sm:w-auto rounded-lg border border-black/10 shadow-sm text-sm focus:border-[#4CAF50] focus:ring-[#4CAF50]">
            ...
            @forelse ($products as $product)
                ...
                <div class="px-4 py-4">
                    ...
                    <div class="flex gap-4 mt-3">
                        <button onclick="openEdit({{ $product->id }})" class="text-[#2f7b35] hover:text-[#1f5a25] text-sm font-medium">Edit</button>
    ...
    <script>
        function resetCreateForm() {
            ...
            if (preview) {
                ...
                preview.className = 'text-sm font-mono text-[#4f8a3d] italic';
            }
        }
