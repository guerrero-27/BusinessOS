...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <div>
        ...
        <select name="category_id" class="w-full border-gray-300 rounded-lg shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">
...
<div>
    ...
    <textarea name="description" rows="2"
        class="w-full border-gray-300 rounded-lg shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $p?->description) }}</textarea>
