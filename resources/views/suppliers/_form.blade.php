<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <div>
        ...
        <select name="is_active" class="w-full rounded-lg border border-black/10 shadow-sm text-sm text-gray-900 focus:border-[#4CAF50] focus:ring-[#4CAF50]">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="address" rows="3"
            class="w-full rounded-lg border border-black/10 shadow-sm text-sm text-gray-900 focus:border-[#4CAF50] focus:ring-[#4CAF50]">{{ old('address', $supplier->address ?? '') }}</textarea>
